# this is an R script uses Nomis API to download UK census data
...
# extract data at district / unitary level
nomis.religion <- nomis_get_data(id = "NM_529_1", 
                                 time = "latest", 
...
# extract data at county / unitary  level
nomis.religion2 <- nomis_get_data(id = "NM_529_1", 
                                 time = "latest", 
...
#  save the files
write.csv(nomis.religion,
          "./data/nomis.religion.csv",
          row.names = FALSE)

write.csv(nomis.religion2,
          "./nomis.religion2.csv",
          row.names = FALSE)
